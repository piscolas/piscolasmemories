...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `Sistema_de_Biblioteca` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Editorial` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Biblioteca` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Libro` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Autor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`libro_has_Autor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Categoria` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`libro_has_categoria` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Idioma` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`idioma_has_libro` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Distribuidor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Cliente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`direccionCliente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`telefonoCliente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`correo_electronicoCliente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Trabajador` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`direccionTrabajador` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`telefonoTrabajador` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`correo_electronicoTrabajador` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Compra_Libro` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Factura` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Boleta` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Venta_Libro` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Arriendo` ;
...
-- -----------------------------------------------------
-- Table `Sistema_de_Biblioteca`.`Usuarios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Sistema_de_Biblioteca`.`Usuarios` ;

CREATE TABLE IF NOT EXISTS `Sistema_de_Biblioteca`.`Usuarios` (
  ...
  `estado` INT NULL,
  `Biblioteca_idBiblioteca` INT NOT NULL,
  PRIMARY KEY (`idUsuarios`, `Biblioteca_idBiblioteca`),
  INDEX `fk_Usuarios_Biblioteca1_idx` (`Biblioteca_idBiblioteca` ASC) VISIBLE,
  CONSTRAINT `fk_Usuarios_Biblioteca1`
    FOREIGN KEY (`Biblioteca_idBiblioteca`)
    REFERENCES `Sistema_de_Biblioteca`.`Biblioteca` (`idBiblioteca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
